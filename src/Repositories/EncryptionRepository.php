...
class EncryptionRepository
{
    ...
    /**
     * EncryptionRepository constructor.
     * @param Container $application
     */
    public function __construct(Container $application)
    {
        $config = $application['config'];
        $this->private_key = file_get_contents($config['private_key_file']);
        $this->zhima_public_key = file_get_contents($config['zhima_public_key_file']);
    }
